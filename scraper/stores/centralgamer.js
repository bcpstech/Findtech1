 ...
 * WooCommerce con delays mayores para evitar 429
 */
const BaseScraper = require('../base-scraper');

const CATEGORY_URLS = [
  { url: 'https://www.centralgamer.cl/producto-categoria/tarjetas-de-video/', catId: 'gpu'     },
  { url: 'https://www.centralgamer.cl/producto-categoria/procesadores/',      catId: 'cpu'     },
  { url: 'https://www.centralgamer.cl/producto-categoria/memorias/',          catId: 'ram'     },
  { url: 'https://www.centralgamer.cl/producto-categoria/almacenamiento/',    catId: 'storage' },
  { url: 'https://www.centralgamer.cl/producto-categoria/refrigeracion/',     catId: 'cooling' },
  { url: 'https://www.centralgamer.cl/producto-categoria/placas-madre/',      catId: 'mobo'    },
  { url: 'https://www.centralgamer.cl/producto-categoria/fuentes/',           catId: 'psu'     },
  { url: 'https://www.centralgamer.cl/producto-categoria/gabinetes/',         catId: 'case'    },
  { url: 'https://www.centralgamer.cl/producto-categoria/monitores/',         catId: 'monitor' },
  { url: 'https://www.centralgamer.cl/producto-categoria/perifericos/',       catId: 'periph'  },
];
...
class CentralGamerScraper extends BaseScraper {
  ...
  async scrapeAll() {
    for (const { url, catId } of CATEGORY_URLS) {
      try { await this.scrapeCategory(url, catId); await this.delay(3000, 6000); }
  ...
  async scrapeCategory(baseUrl, catId) {
    ...
    while (hasMore && page <= 10) {
      ...
      page++; await this.delay(3000, 6000);
    }
  }
}
